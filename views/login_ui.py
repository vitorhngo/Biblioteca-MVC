...
"font: 75 8pt \"Arial\";")
        ...
        sizePolicy2.setHeightForWidth(self.frame_login.sizePolicy().hasHeightForWidth())
        self.frame_login.setSizePolicy(sizePolicy2)
...
"border-radius: 10px;")
        ...
        sizePolicy2.setHeightForWidth(self.frame_username.sizePolicy().hasHeightForWidth())
        self.frame_username.setSizePolicy(sizePolicy2)
...
"border-radius: 10px;")
        ...
        sizePolicy3.setHeightForWidth(self.input_username.sizePolicy().hasHeightForWidth())
        self.input_username.setSizePolicy(sizePolicy3)
        ...
        sizePolicy2.setHeightForWidth(self.frame_pswd.sizePolicy().hasHeightForWidth())
        self.frame_pswd.setSizePolicy(sizePolicy2)
...
"border-radius: 10px;")
        ...
        sizePolicy4.setHeightForWidth(self.input_pswd.sizePolicy().hasHeightForWidth())
        self.input_pswd.setSizePolicy(sizePolicy4)
        ...
        sizePolicy2.setHeightForWidth(self.label_pswd.sizePolicy().hasHeightForWidth())
        self.label_pswd.setSizePolicy(sizePolicy2)
